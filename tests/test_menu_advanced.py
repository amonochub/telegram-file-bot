...
def mock_state_with_history():
    ...
    state.get_data = AsyncMock(
        return_value={"navigation_history": [{"menu": "menu1", "context": {}}, {"menu": "menu2", "context": {}}]}
    )
    state.update_data = AsyncMock()
    return state
...
class TestEdgeCases:
    ...
    async def test_navigation_with_complex_context(self, mock_state):
        ...
        complex_context = {"action": "test_action", "params": {"key": "value"}, "timestamp": 1234567890}
