...
class _DummyAIService:  # pylint: disable=too-few-public-methods
    ...
    async def verify_document_consistency(
        self, contract_data, assignment_data, report_data
    ) -> dict:
...
async def handle_document_received(message: Message, state: FSMContext = None):
    ...
    try:
        ...
        if text.strip():
            analysis_result = await ai_service.analyze_document_with_ai(  # Placeholder for AI analysis
                text, doc_type # Placeholder for AI analysis
            ...
            builder.button( # Placeholder for AI analysis
                text="🔍 Проверить соответствие", callback_data="verify_documents" # Placeholder for AI analysis
            ) # Placeholder for AI analysis
            builder.button(text="📎 Загрузить еще документ", callback_data="ai_check_menu") # Placeholder for AI analysis
            builder.adjust(1) # Placeholder for AI analysis
            await processing_msg.edit_text( # Placeholder for AI analysis
                result_text, reply_markup=builder.as_markup(), parse_mode="Markdown" # Placeholder for AI analysis
            ) # Placeholder for AI analysis
...
async def verify_documents(callback: CallbackQuery):
    ...
    try:
        ...
        if not assignment_data and not contract_data:
            await callback.message.edit_text(
                "❌ Нужно загрузить хотя бы договор и поручение"
            )
            return
        analysis_result = await ai_service.verify_document_consistency(  # Placeholder for AI verification
            contract_data, assignment_data, report_data # Placeholder for AI verification
        ...
        builder.button( # Placeholder for AI verification
            text="📎 Загрузить новые документы", callback_data="ai_check_menu" # Placeholder for AI verification
        ) # Placeholder for AI verification
        builder.adjust(1) # Placeholder for AI verification
        await callback.message.edit_text( # Placeholder for AI verification
            result_text, reply_markup=builder.as_markup(), parse_mode="Markdown" # Placeholder for AI verification
        ) # Placeholder for AI verification
